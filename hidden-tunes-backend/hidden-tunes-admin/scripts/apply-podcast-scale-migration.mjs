/**
 * Apply podcast scale migration (additive columns, indexes, operational tables).
 */
...
const migrationPath = path.join(
  adminRoot,
  "supabase/migrations/20260710180000_podcast_scale.sql"
);
...
async function main() {
  ...
  console.log(
    JSON.stringify({
      ...
      apiResult,
      manual:
        "Apply supabase/migrations/20260710180000_podcast_scale.sql in Supabase SQL editor.",
    })
  );
  process.exit(2);
}
