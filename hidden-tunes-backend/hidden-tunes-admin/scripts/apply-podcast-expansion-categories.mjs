/**
 * Apply podcast mass expansion category migration.
 */
...
const migrationPath = path.join(
  adminRoot,
  "supabase/migrations/20260715120000_podcast_expansion_categories.sql"
);
...
async function main() {
  ...
  console.log(
    JSON.stringify({
      ...
      apiResult,
      manual:
        "Apply supabase/migrations/20260715120000_podcast_expansion_categories.sql in Supabase SQL editor.",
    })
  );
  process.exit(2);
}
