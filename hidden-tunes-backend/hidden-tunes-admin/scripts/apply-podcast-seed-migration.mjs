/**
 * Apply podcast seed catalog migration (episode_guid, categories, feed_url unique).
 */
...
const migrationPath = path.join(
  adminRoot,
  "supabase/migrations/20260705120000_podcast_seed_catalog.sql"
);
...
async function main() {
  ...
  console.log(
    JSON.stringify({
      ...
      apiResult,
      manual:
        "Apply supabase/migrations/20260705120000_podcast_seed_catalog.sql in Supabase SQL editor.",
    })
  );
  process.exit(2);
}
