...
export const PODCAST_CATEGORY_SLUG_ALIASES: Record<string, readonly string[]> = {
  ...
  society: ["society-culture", "society", "culture"],
  culture: ["culture", "society-culture", "society"],
  finance: ["finance", "business"],
  politics: ["politics", "news"],
  arts: ["arts", "music"],
  books: ["books", "education"],
  parenting: ["parenting", "society-culture"],
  relationships: ["relationships", "society-culture"],
  "language-learning": ["language-learning", "education", "language"],
  motivation: ["motivation", "education", "health"],
