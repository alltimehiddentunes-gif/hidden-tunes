...
-- Hidden Tunes audiobook multi-source + mature catalog expansion.
-- Additive only. New providers are registry rows (no schema change required for adapters).

begin;

-- Ensure expansion foundation objects exist (idempotent with 150k migration).
create table if not exists public.audiobook_works (
  id uuid primary key default gen_random_uuid(),
  canonical_title text not null,
  normalized_title text not null,
...
create index if not exists audiobooks_mature_playable_published_idx
  on public.audiobooks (published_at desc nulls last, created_at desc, id desc)
  where status = 'approved' and is_active = true and playback_status = 'playable' and is_mature = true;

create index if not exists audiobooks_public_playable_published_idx
  on public.audiobooks (published_at desc nulls last, created_at desc, id desc)
  where status = 'approved' and is_active = true and playback_status = 'playable' and is_mature = false;

-- Seed / upsert multi-source registry (providers are rows, not schema).
insert into public.audiobook_source_registry (
  source_key, source_name, source_type, base_url, rights_policy, default_license,
  attribution_requirements, supported_languages, supported_formats, is_enabled, metadata
)
values
  ('librivox', 'LibriVox', 'api', 'https://librivox.org/api/feed/audiobooks', 'Public domain volunteer readings', 'public_domain', 'Credit LibriVox and readers', array['English','German','French','Spanish','Italian','Portuguese'], array['mp3','ogg'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:librivoxaudio', 'Internet Archive LibriVox Audio', 'archive', 'https://archive.org/details/librivoxaudio', 'Public domain via Internet Archive', 'public_domain', 'Credit LibriVox and Internet Archive', array['English','German','French','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:opensource_audio', 'Internet Archive Open Source Audio', 'archive', 'https://archive.org/details/opensource_audio', 'Open source / public domain audio', 'open_license', 'Credit Internet Archive', array['English','Spanish','French','German'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:audio_bookspoetry', 'Internet Archive Books & Poetry Audio', 'archive', 'https://archive.org/details/audio_bookspoetry', 'Public domain books and poetry', 'public_domain', 'Credit Internet Archive', array['English','French','German','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:community_audiobooks', 'Internet Archive Community Audiobooks', 'archive', 'https://archive.org', 'PD/CC community audiobooks', 'open_license', 'Credit Internet Archive', array['English','Spanish','French','German','Italian','Portuguese'], array['mp3','ogg','m4a','flac'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:educational_audiobooks', 'Internet Archive Educational Audiobooks', 'archive', 'https://archive.org', 'PD/CC educational spoken audio', 'open_license', 'Credit Internet Archive', array['English','Spanish','French','German'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:multilingual_literature', 'Internet Archive Multilingual Literature', 'archive', 'https://archive.org', 'PD/CC multilingual literature audio', 'open_license', 'Credit Internet Archive', array['Spanish','French','German','Italian','Portuguese','Russian','Chinese','Japanese','Arabic','Hindi'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:public_domain_classics', 'Internet Archive Public Domain Classics', 'archive', 'https://archive.org', 'Public domain classic literature audio', 'public_domain', 'Credit Internet Archive', array['English','French','German','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"general"}'::jsonb),
  ('internet_archive:mature_erotica_pd', 'Internet Archive Mature Erotica PD/CC', 'archive', 'https://archive.org', 'Lawful adult PD/CC audio only', 'open_license', 'Credit Internet Archive and rights holders', array['English','French','German','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"mature"}'::jsonb),
  ('internet_archive:mature_romance_adult', 'Internet Archive Mature Romance PD/CC', 'archive', 'https://archive.org', 'Lawful adult romance PD/CC audio only', 'open_license', 'Credit Internet Archive and rights holders', array['English','French','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"mature"}'::jsonb),
  ('internet_archive:mature_horror_dark', 'Internet Archive Mature Horror/Dark PD/CC', 'archive', 'https://archive.org', 'Lawful mature horror/dark fiction PD/CC', 'open_license', 'Credit Internet Archive and rights holders', array['English','French','German'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"mature"}'::jsonb),
  ('internet_archive:mature_literary_adult', 'Internet Archive Mature Literary Fiction PD/CC', 'archive', 'https://archive.org', 'Lawful adult literary PD/CC audio', 'open_license', 'Credit Internet Archive and rights holders', array['English','French','German','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"mature"}'::jsonb),
  ('internet_archive:mature_adult_nonfiction', 'Internet Archive Adult Non-Fiction PD/CC', 'archive', 'https://archive.org', 'Lawful adult education/non-fiction PD/CC', 'open_license', 'Credit Internet Archive and rights holders', array['English','French','Spanish'], array['mp3','ogg','m4a'], true, '{"catalog_lane":"mature"}'::jsonb)
on conflict (source_key) do update set
  source_name = excluded.source_name,
  base_url = excluded.base_url,
  rights_policy = excluded.rights_policy,
