...
export default function AdminShell({
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#050508] text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-[1500px] flex-col gap-4 px-4 py-4 sm:px-6 lg:grid lg:grid-cols-[290px_1fr] lg:gap-6 lg:px-8 lg:py-6">
        <aside className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.36)] backdrop-blur-xl lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
          <div className="flex items-center justify-between gap-4 lg:block">
            ...
            <div className="rounded-full border border-yellow-300/20 bg-yellow-300/10 px-3 py-2 text-[11px] font-black uppercase tracking-widest text-yellow-100 lg:mt-5 lg:w-fit">
