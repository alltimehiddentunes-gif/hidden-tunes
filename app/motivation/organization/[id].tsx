...
export default function MotivationOrganizationDetailScreen() {
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View style={styles.header}>
              ...
              <Text style={styles.title}>{entity?.displayName || "Organization"}</Text>
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>No programs found for this organization.</Text>
          }
        />
      </LinearGradient>
    </AppShell>
