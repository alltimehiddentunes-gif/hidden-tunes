...
function formatDate(value: string | undefined, recentlyUpdatedLabel: string) {
  if (!value) return recentlyUpdatedLabel;

  try {
    const date = new Date(value);
    if (Number.isNaN(date.getTime())) return recentlyUpdatedLabel;
...
export default function PlaylistDetailScreen() {
  ...
  const musicUi = useMemo(
    () => ({
      smartMix: t("music.playlist.smartMix"),
      playPlaylist: t("music.playlist.playPlaylist"),
      rename: t("music.playlist.rename"),
      clearSongs: t("music.playlist.clearSongs"),
      madeForYou: t("music.playlist.madeForYou"),
      smartMixHelper: t("music.playlist.smartMixHelper"),
      queueSavesHelper: t("music.playlist.queueSavesHelper"),
      notFound: t("music.playlist.notFound"),
      noSongsTitle: t("music.playlist.noSongsTitle"),
      smartEmptyDescription: t("music.playlist.smartEmptyDescription"),
      userEmptyDescription: t("music.playlist.userEmptyDescription"),
      renameTitle: t("music.playlist.renameTitle"),
      saveName: t("music.playlist.saveName"),
      namePlaceholder: t("music.playlist.namePlaceholder"),
      clearTitle: t("music.playlist.clearTitle"),
      clearMessage: (title: string) => t("music.playlist.clearMessage", { title }),
      clearAction: t("music.playlist.clearAction"),
      deleteTitle: t("music.playlist.deleteTitle"),
      deleteMessage: (title: string) => t("music.playlist.deleteMessage", { title }),
      deleteAction: t("music.playlist.deleteAction"),
      fallbackTitle: t("music.playlist.fallbackTitle"),
      cancel: t("common.cancel"),
      recentlyUpdated: t("music.common.recentlyUpdated"),
      autoGenerated: t("music.common.autoGenerated"),
      updatedOn: (date: string) => t("music.common.updatedOn", { date }),
  ...
  function handleClearPlaylist() {
    ...
    Alert.alert(
      musicUi.clearTitle,
      musicUi.clearMessage(playlist.title),
      [
        {
          text: musicUi.cancel,
          style: "cancel",
  ...
  function handleDeletePlaylist() {
    ...
    Alert.alert(
      musicUi.deleteTitle,
      musicUi.deleteMessage(playlist?.title || musicUi.fallbackTitle),
      [
        {
          text: musicUi.cancel,
          style: "cancel",
    ...
    return (
      ...
      <PremiumBackground variant="library" />
        ...
        <View style={styles.missingBox}>
          ...
          <Text style={styles.missing}>{musicUi.notFound}</Text>
        </View>
      </LinearGradient>
    );
  }
          ...
          <View style={styles.hero}>
            ...
            {smart && (
              <View style={styles.smartBadge}>
                ...
                <Text style={styles.smartBadgeText}>{musicUi.smartMix}</Text>
              </View>
            )}
            ...
            <Text style={styles.subtitle}>
              {musicUi.formatSongs(normalizedTracks.length)}
              {smart
                ? ` · ${musicUi.autoGenerated}`
                : ` · ${musicUi.updatedOn(formatDate(playlist.updatedAt, musicUi.recentlyUpdated))}`}
            </Text>
            ...
            <View style={styles.actionRow}>
              ...
              >
                ...
                <Text style={styles.playText}>{musicUi.playPlaylist}</Text>
              </TouchableOpacity>
            ...
            {!smart ? (
              <View style={styles.managementRow}>
                ...
                >
                  ...
                  />
                  <Text style={styles.managePillText}>{musicUi.rename}</Text>
                </TouchableOpacity>
                ...
                >
                  <Ionicons
                    ...
                    color={COLORS.primary}
                  />
                  <Text style={styles.managePillText}>{musicUi.clearSongs}</Text>
                </TouchableOpacity>
              </View>
            ) : (
              <View style={styles.managementRow}>
                <View style={styles.managePill}>
                  ...
                  <Text style={styles.managePillText}>{musicUi.madeForYou}</Text>
                </View>
              </View>
            )}
            ...
            <View style={styles.helperPill}>
              ...
              <Text style={styles.helperText}>
                {smart ? musicUi.smartMixHelper : musicUi.queueSavesHelper}
              </Text>
            </View>
          </View>
        }
        ListEmptyComponent={
          <View style={styles.emptyBox}>
            ...
            <Text style={styles.emptyText}>
              {smart ? musicUi.smartEmptyDescription : musicUi.userEmptyDescription}
            </Text>
          </View>
        }
          ...
          <Pressable style={styles.modalOverlay} onPress={closeRenameModal}>
            <Pressable style={styles.modalSheet}>
              <View style={styles.modalHeader}>
                <View>
                  <Text style={styles.modalTitle}>{musicUi.renameTitle}</Text>
              ...
              <TextInput
                ...
                placeholder={musicUi.namePlaceholder}
              ...
              >
                <Text style={styles.renameButtonText}>{musicUi.saveName}</Text>
              </TouchableOpacity>
            </Pressable>
          </Pressable>
        </Modal>
