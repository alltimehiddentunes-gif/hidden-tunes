#!/usr/bin/env node
/**
 * Gradle 9.x removed JvmVendorSpec.IBM_SEMERU. React Native's gradle-plugin
 * still pins foojay-resolver-convention 0.5.0, which crashes local/EAS prebuild.
 * Bump to 1.0.0 after every npm install.
 */
import fs from "fs";
