...
export const TV_CHANNEL_SEEDS: TVChannel[] = [
  ...
  // Movie Channels (linear FAST)
  seedChannel({
    id: "moviesphere",
    name: "MovieSphere",
    description: "Round-the-clock movies from Lionsgate authorized FAST.",
    streamUrl: "https://pb-wmei1j77c66s0.akamaized.net/MovieSphere.m3u8",
    websiteUrl: "https://www.lionsgate.com/",
    country: "US",
    language: "English",
    category: "movie",
    sourceType: "fast",
  ...
  seedChannel({
    ...
    description: "Black cinema classics and hits on authorized Roku FAST.",
    streamUrl:
  ...
  seedChannel({
    ...
    description: "Classic films on Samsung TV Plus authorized FAST.",
  ...
  seedChannel({
    id: "cinevault-80s",
    name: "Cinevault 80s",
    description: "1980s movies on authorized Roku FAST.",
    streamUrl: "https://gsn-cinevault-80s-2-us.roku.wurl.tv/playlist.m3u8",
    country: "US",
    language: "English",
    category: "movie",
    subCategory: "classics",
  ...
  seedChannel({
    ...
    description: "Western movies on authorized Roku FAST.",
  ...
  seedChannel({
    id: "samuel-goldwyn-classics",
    name: "Samuel Goldwyn Classics",
    description: "Hollywood classics on authorized Roku FAST.",
    streamUrl: "https://samuelgoldwyn-classics-1-us.roku.wurl.tv/playlist.m3u8",
    country: "US",
    language: "English",
    category: "movie",
    subCategory: "classics",
  ...
  seedChannel({
    ...
    description: "Family-friendly movies on authorized FAST.",
    streamUrl: "https://pb-clwlfvkqpn19r.akamaized.net/Hallmark_Movies_%26_More.m3u8",
    websiteUrl: "https://www.hallmarkchannel.com/",
    country: "US",
    language: "English",
    category: "movie",
    subCategory: "family",
  ...
  seedChannel({
    ...
    description: "Action movies on authorized Pluto TV FAST.",
  ...
  seedChannel({
    id: "pluto-comedy-movies",
    name: "Pluto TV Comedy Movies",
    description: "Comedy movies on authorized Pluto TV FAST.",
    streamUrl: "https://jmp2.uk/plu-62ea3d24b8e02600071fa296.m3u8",
    websiteUrl: "https://pluto.tv/",
    country: "US",
    language: "English",
    category: "movie",
  ...
  seedChannel({
    ...
    description: "Cult and indie films on authorized Pluto TV FAST.",
    streamUrl: "https://jmp2.uk/plu-5c665db3e6c01b72c4977bc2.m3u8",
    websiteUrl: "https://pluto.tv/",
    country: "US",
    language: "English",
    category: "movie",
  ...
  seedChannel({
    id: "kids-movie-club",
    name: "Kids Movie Club",
    description: "Family movies on authorized Pluto TV FAST.",
    streamUrl: "https://jmp2.uk/plu-5db0ad56edc89300090d2ebb.m3u8",
    websiteUrl: "https://pluto.tv/",
    country: "US",
    language: "English",
    category: "movie",
  ...
  seedChannel({
    ...
    description: "Independent films on authorized FAST.",
    streamUrl: "https://d6dg3ebeih71x.cloudfront.net/Gravitas_Movies.m3u8",
    country: "US",
    language: "English",
    category: "movie",
    subCategory: "indie",
  ...
  seedChannel({
    ...
    description: "Restored public-domain classics on Cinedigm FAST.",
    streamUrl:
      "https://cinedigm-entertainment-corp-thefilmdetective-1-us.ono.wurl.tv/playlist.m3u8",
    country: "US",
    language: "English",
    category: "movie",
    subCategory: "public_domain",
    sourceType: "fast",
  }),
  seedChannel({
    id: "mytime-movie-network",
    name: "MyTime Movie Network",
    description: "Hollywood movies on authorized Samsung TV Plus FAST.",
    streamUrl: "https://appletree-mytimeau-samsung.amagi.tv/playlist.m3u8",
    country: "US",
    language: "English",
    category: "movie",
    sourceType: "fast",
