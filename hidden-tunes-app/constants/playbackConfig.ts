 ...
 * NEVER IN: Expo Go — RNTP is not bundled there; HiddenAudio handles playback in dev/preview builds.
 *
...
/**
 * iOS uses HiddenAudio until RNTP lock-screen playback is stable on preview builds.
