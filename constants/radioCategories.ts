...
export const RADIO_BROWSE_CATEGORIES: RadioCategory[] = [
  ...
  },
  {
    id: "news",
    title: "News",
    subtitle: "Headlines, public radio, and current affairs",
    icon: "newspaper-outline",
    gradient: ["#101828", "#080C14"],
    tag: "news",
    tier: "browse",
    listeningRoomQuery: "news radio",
  },
  {
    id: "african-radio",
    title: "African Radio",
    subtitle: "Afrobeats, talk, gospel, and stations across Africa",
    icon: "earth-outline",
    gradient: ["#2A1420", "#100810"],
    tag: "african",
    tier: "browse",
  ...
  },
  {
    id: "new-this-week",
    title: "New This Week",
    subtitle: "Fresh stations and newly active streams",
    icon: "sparkles-outline",
    gradient: ["#102028", "#081014"],
    tag: "new",
    tier: "browse",
    listeningRoomQuery: "new radio stations",
  },
  {
    id: "recently-added",
    title: "Recently Added",
    subtitle: "Stations that feel newly discovered",
    icon: "add-circle-outline",
    gradient: ["#141820", "#080A10"],
    tag: "community",
    tier: "browse",
    listeningRoomQuery: "recent radio stations",
  },
  {
    id: "hidden-gems",
    title: "Hidden Gems",
    subtitle: "Undiscovered stations with strong signals",
    icon: "diamond-outline",
    gradient: ["#181828", "#0A0A14"],
    tag: "indie",
    tier: "browse",
    listeningRoomQuery: "hidden gem radio",
  },
  {
    id: "editors-picks",
    title: "Editor's Picks",
    subtitle: "Quality-first stations worth trying next",
    icon: "star-outline",
    gradient: ["#241028", "#100810"],
    useTopVotes: true,
    tier: "browse",
    listeningRoomQuery: "editor picked radio",
  },
  {
    id: "most-loved",
    title: "Most Loved",
    subtitle: "Highly voted stations from the global catalog",
    icon: "heart-outline",
    gradient: ["#241020", "#100810"],
    useTopVotes: true,
    tier: "browse",
    listeningRoomQuery: "most loved radio",
  },
  {
    id: "popular-country",
    title: "Popular In Your Country",
    subtitle: "Strong stations near your current region",
    icon: "location-outline",
    gradient: ["#142820", "#081410"],
    countryCode: "US",
    tier: "browse",
    listeningRoomQuery: "popular local radio",
  },
  {
    id: "popular-worldwide",
    title: "Popular Worldwide",
    subtitle: "Global stations with broad listener momentum",
    icon: "globe-outline",
