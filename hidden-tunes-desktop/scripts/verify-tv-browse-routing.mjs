...
check('filtered Search sends category to canonical TV catalog', data.includes('query: trimmedSearch') && data.includes('category: category ?? undefined'))
check('filtered Search sends country to canonical TV catalog', data.includes('country: effectiveSelectedRegion ?? undefined'))
...
check('region cards use canonical handler', page.includes('handleRegionSelect(region.name)'))
