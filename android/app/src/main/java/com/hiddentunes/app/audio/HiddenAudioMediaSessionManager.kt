...
object HiddenAudioMediaSessionManager {
  ...
  private val sessionCallback = object : MediaSessionCompat.Callback() {
    ...
    override fun onPause() {
      HiddenAudioCore.emitAutoDiagnostic("android_auto_pause_command_received")
      HiddenAudioCore.pauseForcedFromSession()
    }

    override fun onSkipToNext() {
      HiddenAudioCore.emitAutoDiagnostic("android_auto_next_command_received")
      HiddenAudioCore.skipToNextFromSession()
    }

    override fun onSkipToPrevious() {
      HiddenAudioCore.emitAutoDiagnostic("android_auto_previous_command_received")
