...
const MATURE_ALIAS_GROUPS: AliasGroup[] = [
  {
    canonical: "dating",
    aliases: ["relationships", "intimacy", "adult talk", "after dark"],
    tags: ["dating", "relationships"],
    podcastQueries: ["dating podcast", "relationships adult"],
    matureOnly: true,
  },
  {
    canonical: "adult",
    aliases: ["mature", "after dark", "human behavior", "intimacy"],
    tags: ["adult", "talk"],
    podcastQueries: ["adult podcast", "after dark"],
    matureOnly: true,
  },
  {
    canonical: "marriage",
    aliases: ["relationships", "couples", "intimacy"],
    podcastQueries: ["marriage podcast", "relationships"],
    matureOnly: true,
  },
];
